<template>
  <div class="card">
    ...
    <div v-if="balance">
      <div style="margin-bottom: 8px;">可用余额：¥{{ fenToYuan(balance.available_cents) }}</div>
      <div style="margin-bottom: 8px;">冻结：¥{{ fenToYuan(balance.locked_cents) }}</div>
      <div style="margin-bottom: 8px;">总额：¥{{ fenToYuan(balance.total_cents) }}</div>
