...
func Hide(v bool) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldHide, v))
}
...
func PositionEQ(v Position) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldPosition, v))
}

// PositionNEQ applies the NEQ predicate on the "position" field.
func PositionNEQ(v Position) predicate.Tag {
	return predicate.Tag(sql.FieldNEQ(FieldPosition, v))
}

// PositionIn applies the In predicate on the "position" field.
func PositionIn(vs ...Position) predicate.Tag {
	return predicate.Tag(sql.FieldIn(FieldPosition, vs...))
}

// PositionNotIn applies the NotIn predicate on the "position" field.
func PositionNotIn(vs ...Position) predicate.Tag {
	return predicate.Tag(sql.FieldNotIn(FieldPosition, vs...))
}

// HideEQ applies the EQ predicate on the "hide" field.
func HideEQ(v bool) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldHide, v))
}

// HideNEQ applies the NEQ predicate on the "hide" field.
func HideNEQ(v bool) predicate.Tag {
	return predicate.Tag(sql.FieldNEQ(FieldHide, v))
}
