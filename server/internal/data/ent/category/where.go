...
func SubsiteID(v uint64) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldSubsiteID, v))
}
...
func Hide(v bool) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldHide, v))
}

// Sort applies equality check predicate on the "sort" field. It's identical to SortEQ.
func Sort(v int32) predicate.Category {
...
func SubsiteIDEQ(v uint64) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldSubsiteID, v))
}

// SubsiteIDNEQ applies the NEQ predicate on the "subsite_id" field.
func SubsiteIDNEQ(v uint64) predicate.Category {
	return predicate.Category(sql.FieldNEQ(FieldSubsiteID, v))
}

// SubsiteIDIn applies the In predicate on the "subsite_id" field.
func SubsiteIDIn(vs ...uint64) predicate.Category {
	return predicate.Category(sql.FieldIn(FieldSubsiteID, vs...))
}

// SubsiteIDNotIn applies the NotIn predicate on the "subsite_id" field.
func SubsiteIDNotIn(vs ...uint64) predicate.Category {
	return predicate.Category(sql.FieldNotIn(FieldSubsiteID, vs...))
}

// SubsiteIDGT applies the GT predicate on the "subsite_id" field.
func SubsiteIDGT(v uint64) predicate.Category {
	return predicate.Category(sql.FieldGT(FieldSubsiteID, v))
}

// SubsiteIDGTE applies the GTE predicate on the "subsite_id" field.
func SubsiteIDGTE(v uint64) predicate.Category {
	return predicate.Category(sql.FieldGTE(FieldSubsiteID, v))
}

// SubsiteIDLT applies the LT predicate on the "subsite_id" field.
func SubsiteIDLT(v uint64) predicate.Category {
	return predicate.Category(sql.FieldLT(FieldSubsiteID, v))
}

// SubsiteIDLTE applies the LTE predicate on the "subsite_id" field.
func SubsiteIDLTE(v uint64) predicate.Category {
	return predicate.Category(sql.FieldLTE(FieldSubsiteID, v))
}
...
func HideEQ(v bool) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldHide, v))
}

// HideNEQ applies the NEQ predicate on the "hide" field.
func HideNEQ(v bool) predicate.Category {
	return predicate.Category(sql.FieldNEQ(FieldHide, v))
}

// SortEQ applies the EQ predicate on the "sort" field.
func SortEQ(v int32) predicate.Category {
	return predicate.Category(sql.FieldEQ(FieldSort, v))
}

// SortNEQ applies the NEQ predicate on the "sort" field.
func SortNEQ(v int32) predicate.Category {
	return predicate.Category(sql.FieldNEQ(FieldSort, v))
}

// SortIn applies the In predicate on the "sort" field.
func SortIn(vs ...int32) predicate.Category {
	return predicate.Category(sql.FieldIn(FieldSort, vs...))
}

// SortNotIn applies the NotIn predicate on the "sort" field.
func SortNotIn(vs ...int32) predicate.Category {
	return predicate.Category(sql.FieldNotIn(FieldSort, vs...))
}

// SortGT applies the GT predicate on the "sort" field.
func SortGT(v int32) predicate.Category {
	return predicate.Category(sql.FieldGT(FieldSort, v))
}

// SortGTE applies the GTE predicate on the "sort" field.
func SortGTE(v int32) predicate.Category {
	return predicate.Category(sql.FieldGTE(FieldSort, v))
}

// SortLT applies the LT predicate on the "sort" field.
func SortLT(v int32) predicate.Category {
	return predicate.Category(sql.FieldLT(FieldSort, v))
}

// SortLTE applies the LTE predicate on the "sort" field.
func SortLTE(v int32) predicate.Category {
	return predicate.Category(sql.FieldLTE(FieldSort, v))
}

// VisibleSubsitesIsNil applies the IsNil predicate on the "visible_subsites" field.
func VisibleSubsitesIsNil() predicate.Category {
	return predicate.Category(sql.FieldIsNull(FieldVisibleSubsites))
}
