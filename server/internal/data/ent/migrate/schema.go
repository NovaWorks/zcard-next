...
var (
	...
	LicenseOrdersColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "plan", Type: field.TypeEnum, Enums: []string{"monthly", "yearly"}},
		{Name: "amount", Type: field.TypeInt64},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"pending", "success", "canceled"}, Default: "pending"},
		{Name: "payer_user_id", Type: field.TypeUint64},
		...
		{Name: "expires_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "datetime(3)"}},
		{Name: "license_file", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "paid_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "datetime(3)"}},
	}
	// LicenseOrdersTable holds the schema information for the "license_orders" table.
	LicenseOrdersTable = &schema.Table{
		Name:       "license_orders",
		Columns:    LicenseOrdersColumns,
		PrimaryKey: []*schema.Column{LicenseOrdersColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "licenseorder_payer_user_id",
				Unique:  false,
				Columns: []*schema.Column{LicenseOrdersColumns[6]},
			},
			{
				Name:    "licenseorder_instance_id",
				Unique:  false,
				Columns: []*schema.Column{LicenseOrdersColumns[7]},
			},
		},
	}
