...
func (_u *SessionUpdate) SetRealm(v session.Realm) *SessionUpdate {
	_u.mutation.SetRealm(v)
	return _u
}

// SetNillableRealm sets the "realm" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableRealm(v *session.Realm) *SessionUpdate {
	if v != nil {
		_u.SetRealm(*v)
	}
	return _u
...
func (_u *SessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Realm(); ok {
...
// SetRealm sets the "realm" field.
func (_u *SessionUpdateOne) SetRealm(v session.Realm) *SessionUpdateOne {
	_u.mutation.SetRealm(v)
	return _u
}

// SetNillableRealm sets the "realm" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableRealm(v *session.Realm) *SessionUpdateOne {
	if v != nil {
		_u.SetRealm(*v)
	}
	return _u
