...
func (_q *MemberLevelQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MemberLevelQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *MemberLevelQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *MemberLevelQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *MemberLevelQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *MemberLevelQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *MemberLevelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(memberlevel.Table, memberlevel.Columns, sqlgraph.NewFieldSpec(memberlevel.FieldID, field.TypeUint64))
	_spec.From = _q.sql
...
func (_q *MemberLevelQuery) ForUpdate(opts ...sql.LockOption) *MemberLevelQuery {
...
func (_q *MemberLevelQuery) ForShare(opts ...sql.LockOption) *MemberLevelQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
