...
func (_q *UserSessionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserSessionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *UserSessionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserSessionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *UserSessionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *UserSessionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserSessionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usersession.Table, usersession.Columns, sqlgraph.NewFieldSpec(usersession.FieldID, field.TypeUint64))
	_spec.From = _q.sql
