...
const (
	...
	// FieldSpecialPrice holds the string denoting the special_price field in the database.
	FieldSpecialPrice = "special_price"
...
var (
	...
	// DefaultSpecialPrice holds the default value on creation for the "special_price" field.
	DefaultSpecialPrice int64
...
const (
	...
	TypeSpecialPrice Type = "special_price"
)
...
func TypeValidator(_type Type) error {
	switch _type {
	case TypeFixed, TypePercent, TypeSpecialPrice:
		return nil
	default:
		return fmt.Errorf("promotion: invalid enum value for type field: %q", _type)
	}
}
...
// BySpecialPrice orders the results by the special_price field.
func BySpecialPrice(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSpecialPrice, opts...).ToFunc()
}
