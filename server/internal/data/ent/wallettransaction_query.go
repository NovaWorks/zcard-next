...
func (_q *WalletTransactionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *WalletTransactionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *WalletTransactionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *WalletTransactionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *WalletTransactionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *WalletTransactionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(wallettransaction.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.WalletTransaction.Query().
//		Select(wallettransaction.FieldUserID).
//		Scan(ctx, &v)
...
func (_q *WalletTransactionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(wallettransaction.Table, wallettransaction.Columns, sqlgraph.NewFieldSpec(wallettransaction.FieldID, field.TypeUint64))
	_spec.From = _q.sql
