...
type OrderQuery struct {
	...
	withAmountLines  *OrderAmountLineQuery
	withStatusEvents *OrderStatusEventQuery
	withPayments     *PaymentQuery
	withDeliveries   *OrderDeliveryQuery
	withRefunds      *RefundOrderQuery
...
// QueryAmountLines chains the current query on the "amount_lines" edge.
func (_q *OrderQuery) QueryAmountLines() *OrderAmountLineQuery {
	query := (&OrderAmountLineClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrderQuery) QueryStatusEvents() *OrderStatusEventQuery {
	query := (&OrderStatusEventClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrderQuery) QueryDeliveries() *OrderDeliveryQuery {
	query := (&OrderDeliveryClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrderQuery) QueryRefunds() *RefundOrderQuery {
	query := (&RefundOrderClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrderQuery) Clone() *OrderQuery {
	...
	return &OrderQuery{
		...
		withAmountLines:  _q.withAmountLines.Clone(),
...
// WithAmountLines tells the query-builder to eager-load the nodes that are connected to
// the "amount_lines" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *OrderQuery) WithAmountLines(opts ...func(*OrderAmountLineQuery)) *OrderQuery {
	query := (&OrderAmountLineClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAmountLines = query
	return _q
}
...
func (_q *OrderQuery) WithStatusEvents(opts ...func(*OrderStatusEventQuery)) *OrderQuery {
	query := (&OrderStatusEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrderQuery) WithDeliveries(opts ...func(*OrderDeliveryQuery)) *OrderQuery {
	query := (&OrderDeliveryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrderQuery) WithRefunds(opts ...func(*RefundOrderQuery)) *OrderQuery {
	query := (&RefundOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrderQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Order, error) {
	...
	if query := _q.withAmountLines; query != nil {
		if err := _q.loadAmountLines(ctx, query, nodes,
			func(n *Order) { n.Edges.AmountLines = []*OrderAmountLine{} },
			func(n *Order, e *OrderAmountLine) { n.Edges.AmountLines = append(n.Edges.AmountLines, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withStatusEvents; query != nil {
		if err := _q.loadStatusEvents(ctx, query, nodes,
			func(n *Order) { n.Edges.StatusEvents = []*OrderStatusEvent{} },
			func(n *Order, e *OrderStatusEvent) { n.Edges.StatusEvents = append(n.Edges.StatusEvents, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withDeliveries; query != nil {
		if err := _q.loadDeliveries(ctx, query, nodes,
			func(n *Order) { n.Edges.Deliveries = []*OrderDelivery{} },
			func(n *Order, e *OrderDelivery) { n.Edges.Deliveries = append(n.Edges.Deliveries, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRefunds; query != nil {
		if err := _q.loadRefunds(ctx, query, nodes,
			func(n *Order) { n.Edges.Refunds = []*RefundOrder{} },
			func(n *Order, e *RefundOrder) { n.Edges.Refunds = append(n.Edges.Refunds, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OrderQuery) loadAmountLines(ctx context.Context, query *OrderAmountLineQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderAmountLine)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Order)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orderamountline.FieldOrderID)
	}
	query.Where(predicate.OrderAmountLine(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(order.AmountLinesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrderQuery) loadStatusEvents(ctx context.Context, query *OrderStatusEventQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderStatusEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Order)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orderstatusevent.FieldOrderID)
	}
	query.Where(predicate.OrderStatusEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(order.StatusEventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrderQuery) loadDeliveries(ctx context.Context, query *OrderDeliveryQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderDelivery)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Order)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orderdelivery.FieldOrderID)
	}
	query.Where(predicate.OrderDelivery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(order.DeliveriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *OrderQuery) loadRefunds(ctx context.Context, query *RefundOrderQuery, nodes []*Order, init func(*Order), assign func(*Order, *RefundOrder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint64]*Order)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(refundorder.FieldOrderID)
	}
	query.Where(predicate.RefundOrder(func(s *sql.Selector) {
