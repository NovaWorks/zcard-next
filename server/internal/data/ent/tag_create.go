...
func (_c *TagCreate) SetPosition(v tag.Position) *TagCreate {
	_c.mutation.SetPosition(v)
	return _c
}

// SetNillablePosition sets the "position" field if the given value is not nil.
func (_c *TagCreate) SetNillablePosition(v *tag.Position) *TagCreate {
	if v != nil {
		_c.SetPosition(*v)
	}
	return _c
...
func (_c *TagCreate) SetHide(v bool) *TagCreate {
	_c.mutation.SetHide(v)
	return _c
}

// SetNillableHide sets the "hide" field if the given value is not nil.
func (_c *TagCreate) SetNillableHide(v *bool) *TagCreate {
	if v != nil {
		_c.SetHide(*v)
	}
	return _c
...
func (_c *TagCreate) check() error {
	...
	if _, ok := _c.mutation.Position(); !ok {
		return &ValidationError{Name: "position", err: errors.New(`ent: missing required field "Tag.position"`)}
	}
	if v, ok := _c.mutation.Position(); ok {
		if err := tag.PositionValidator(v); err != nil {
			return &ValidationError{Name: "position", err: fmt.Errorf(`ent: validator failed for field "Tag.position": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Hide(); !ok {
		return &ValidationError{Name: "hide", err: errors.New(`ent: missing required field "Tag.hide"`)}
	}
	return nil
}
...
func (_c *TagCreate) createSpec() (*Tag, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Position(); ok {
		_spec.SetField(tag.FieldPosition, field.TypeEnum, value)
		_node.Position = value
	}
	if value, ok := _c.mutation.Hide(); ok {
		_spec.SetField(tag.FieldHide, field.TypeBool, value)
		_node.Hide = value
	}
	return _node, _spec
}
...
// SetPosition sets the "position" field.
func (u *TagUpsert) SetPosition(v tag.Position) *TagUpsert {
	u.Set(tag.FieldPosition, v)
	return u
}

// UpdatePosition sets the "position" field to the value that was provided on create.
func (u *TagUpsert) UpdatePosition() *TagUpsert {
	u.SetExcluded(tag.FieldPosition)
	return u
}

// SetHide sets the "hide" field.
func (u *TagUpsert) SetHide(v bool) *TagUpsert {
	u.Set(tag.FieldHide, v)
	return u
}

// UpdateHide sets the "hide" field to the value that was provided on create.
func (u *TagUpsert) UpdateHide() *TagUpsert {
	u.SetExcluded(tag.FieldHide)
	return u
}
...
// SetPosition sets the "position" field.
func (u *TagUpsertOne) SetPosition(v tag.Position) *TagUpsertOne {
	return u.Update(func(s *TagUpsert) {
		s.SetPosition(v)
	})
}
...
// UpdatePosition sets the "position" field to the value that was provided on create.
func (u *TagUpsertOne) UpdatePosition() *TagUpsertOne {
	return u.Update(func(s *TagUpsert) {
		s.UpdatePosition()
	})
}
...
// SetHide sets the "hide" field.
func (u *TagUpsertOne) SetHide(v bool) *TagUpsertOne {
	return u.Update(func(s *TagUpsert) {
		s.SetHide(v)
	})
}
...
// UpdateHide sets the "hide" field to the value that was provided on create.
func (u *TagUpsertOne) UpdateHide() *TagUpsertOne {
	return u.Update(func(s *TagUpsert) {
		s.UpdateHide()
	})
}
...
// SetPosition sets the "position" field.
func (u *TagUpsertBulk) SetPosition(v tag.Position) *TagUpsertBulk {
	return u.Update(func(s *TagUpsert) {
		s.SetPosition(v)
	})
}
...
// UpdatePosition sets the "position" field to the value that was provided on create.
func (u *TagUpsertBulk) UpdatePosition() *TagUpsertBulk {
	return u.Update(func(s *TagUpsert) {
		s.UpdatePosition()
	})
}
...
// SetHide sets the "hide" field.
func (u *TagUpsertBulk) SetHide(v bool) *TagUpsertBulk {
	return u.Update(func(s *TagUpsert) {
		s.SetHide(v)
	})
}
...
// UpdateHide sets the "hide" field to the value that was provided on create.
func (u *TagUpsertBulk) UpdateHide() *TagUpsertBulk {
	return u.Update(func(s *TagUpsert) {
		s.UpdateHide()
	})
}
