...
func (_q *PaymentQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *PaymentQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *PaymentQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *PaymentQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentQuery) loadOrder(ctx context.Context, query *OrderQuery, nodes []*Payment, init func(*Payment), assign func(*Payment, *Order)) error {
	...
	nodeids := make(map[uint64][]*Payment)
	for i := range nodes {
		fk := nodes[i].OrderID
...
func (_q *PaymentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(payment.Table, payment.Columns, sqlgraph.NewFieldSpec(payment.FieldID, field.TypeUint64))
	_spec.From = _q.sql
