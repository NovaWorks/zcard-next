...
func (_q *CartItemQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CartItemQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *CartItemQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CartItemQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *CartItemQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *CartItemQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CartItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cartitem.Table, cartitem.Columns, sqlgraph.NewFieldSpec(cartitem.FieldID, field.TypeUint64))
	_spec.From = _q.sql
