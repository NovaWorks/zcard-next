...
func (_q *PaymentChannelQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentChannelQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *PaymentChannelQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PaymentChannelQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *PaymentChannelQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *PaymentChannelQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(paymentchannel.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PaymentChannel.Query().
//		Select(paymentchannel.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *PaymentChannelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentchannel.Table, paymentchannel.Columns, sqlgraph.NewFieldSpec(paymentchannel.FieldID, field.TypeUint64))
	_spec.From = _q.sql
