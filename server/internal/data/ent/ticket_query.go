...
func (_q *TicketQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *TicketQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *TicketQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *TicketQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *TicketQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *TicketQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TicketQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(ticket.Table, ticket.Columns, sqlgraph.NewFieldSpec(ticket.FieldID, field.TypeUint64))
	_spec.From = _q.sql
