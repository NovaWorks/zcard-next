...
func (_q *OutboxEventQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *OutboxEventQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *OutboxEventQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *OutboxEventQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *OutboxEventQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *OutboxEventQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(outboxevent.FieldModule).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OutboxEvent.Query().
//		Select(outboxevent.FieldModule).
//		Scan(ctx, &v)
...
func (_q *OutboxEventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(outboxevent.Table, outboxevent.Columns, sqlgraph.NewFieldSpec(outboxevent.FieldID, field.TypeUint64))
	_spec.From = _q.sql
