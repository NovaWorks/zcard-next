...
func Sort(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldEQ(FieldSort, v))
}
...
func SortEQ(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldEQ(FieldSort, v))
}

// SortNEQ applies the NEQ predicate on the "sort" field.
func SortNEQ(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldNEQ(FieldSort, v))
}

// SortIn applies the In predicate on the "sort" field.
func SortIn(vs ...int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldIn(FieldSort, vs...))
}

// SortNotIn applies the NotIn predicate on the "sort" field.
func SortNotIn(vs ...int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldNotIn(FieldSort, vs...))
}

// SortGT applies the GT predicate on the "sort" field.
func SortGT(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldGT(FieldSort, v))
}

// SortGTE applies the GTE predicate on the "sort" field.
func SortGTE(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldGTE(FieldSort, v))
}

// SortLT applies the LT predicate on the "sort" field.
func SortLT(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldLT(FieldSort, v))
}

// SortLTE applies the LTE predicate on the "sort" field.
func SortLTE(v int32) predicate.PostCategory {
	return predicate.PostCategory(sql.FieldLTE(FieldSort, v))
}
