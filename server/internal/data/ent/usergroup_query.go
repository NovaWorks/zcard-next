...
func (_q *UserGroupQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserGroupQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *UserGroupQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserGroupQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *UserGroupQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *UserGroupQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserGroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usergroup.Table, usergroup.Columns, sqlgraph.NewFieldSpec(usergroup.FieldID, field.TypeUint64))
	_spec.From = _q.sql
