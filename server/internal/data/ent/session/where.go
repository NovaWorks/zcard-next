...
func RealmEQ(v Realm) predicate.Session {
	return predicate.Session(sql.FieldEQ(FieldRealm, v))
}

// RealmNEQ applies the NEQ predicate on the "realm" field.
func RealmNEQ(v Realm) predicate.Session {
	return predicate.Session(sql.FieldNEQ(FieldRealm, v))
}

// RealmIn applies the In predicate on the "realm" field.
func RealmIn(vs ...Realm) predicate.Session {
	return predicate.Session(sql.FieldIn(FieldRealm, vs...))
}

// RealmNotIn applies the NotIn predicate on the "realm" field.
func RealmNotIn(vs ...Realm) predicate.Session {
	return predicate.Session(sql.FieldNotIn(FieldRealm, vs...))
}
