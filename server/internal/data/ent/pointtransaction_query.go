...
func (_q *PointTransactionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PointTransactionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *PointTransactionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *PointTransactionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *PointTransactionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *PointTransactionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(pointtransaction.FieldUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.PointTransaction.Query().
//		Select(pointtransaction.FieldUserID).
//		Scan(ctx, &v)
...
func (_q *PointTransactionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pointtransaction.Table, pointtransaction.Columns, sqlgraph.NewFieldSpec(pointtransaction.FieldID, field.TypeUint64))
	_spec.From = _q.sql
