...
func (_q *ProcessedEventQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ProcessedEventQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *ProcessedEventQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *ProcessedEventQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *ProcessedEventQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *ProcessedEventQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ProcessedEventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(processedevent.Table, processedevent.Columns, sqlgraph.NewFieldSpec(processedevent.FieldID, field.TypeUint64))
	_spec.From = _q.sql
...
func (_q *ProcessedEventQuery) ForUpdate(opts ...sql.LockOption) *ProcessedEventQuery {
...
func (_q *ProcessedEventQuery) ForShare(opts ...sql.LockOption) *ProcessedEventQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
