...
func init() {
	Declare(
		...
		Perm{Code: "settings:read", Desc: "查看主题设置", Domain: "settings", Op: "zcard.api.admin.v1.AdminSettingsService/GetThemeSettings", Method: "GET", Path: "/api/v1/admin/settings/themes/{key}"},
		Perm{Code: "settings:update", Desc: "保存主题设置", Domain: "settings", Op: "zcard.api.admin.v1.AdminSettingsService/SaveThemeSettings", Method: "PUT", Path: "/api/v1/admin/settings/themes/{key}"},
		Perm{Code: "settings:update", Desc: "预览主题", Domain: "settings", Op: "zcard.api.admin.v1.AdminSettingsService/PreviewThemeSettings", Method: "POST", Path: "/api/v1/admin/settings/themes/{key}/preview"},
		...
		Perm{Code: "identity:user_create", Desc: "新增用户（超管）", Domain: "identity", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminUserManageService/CreateUser", Method: "POST", Path: "/api/v1/admin/users"},
		Perm{Code: "identity:user_reset_pwd", Desc: "重置用户密码（超管）", Domain: "identity", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminUserManageService/ResetUserPassword", Method: "PUT", Path: "/api/v1/admin/users/{id}/password"},
		...
		Perm{Code: "catalog:write", Desc: "批量修改商品分类（超管）", Domain: "catalog", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminCatalogService/BatchUpdateProductCategory", Method: "POST", Path: "/api/v1/admin/products/batch-category"},
		Perm{Code: "catalog:write", Desc: "批量修改商品内容", Domain: "catalog", AdminOnly: true, Op: "zcard.api.admin.v1.AdminCatalogService/GetBatchProductContentResult", Method: "GET", Path: "/api/v1/admin/products/batch-content/results/{request_id}"},
		Perm{Code: "catalog:write", Desc: "批量修改商品内容", Domain: "catalog", AdminOnly: true, Op: "zcard.api.admin.v1.AdminCatalogService/BatchUpdateProductContent", Method: "POST", Path: "/api/v1/admin/products/batch-content"},
		Perm{Code: "catalog:write", Desc: "批量修改商品内容", Domain: "catalog", AdminOnly: true, Op: "zcard.api.admin.v1.AdminCatalogService/PreviewBatchUpdateProductContent", Method: "POST", Path: "/api/v1/admin/products/batch-content/preview"},
		...
		Perm{Code: "supply:write", Desc: "重试商品导入（超管）", Domain: "supply", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminSupplyService/RetryImportTask", Method: "POST", Path: "/api/v1/admin/supply/sync-tasks/{id}/retry"},
		Perm{Code: "supply:read", Desc: "商品导入明细", Domain: "supply",
			Op: "zcard.api.admin.v1.AdminSupplyService/ListImportItems", Method: "GET", Path: "/api/v1/admin/supply/sync-tasks/{id}/items"},
		...
		Perm{Code: "lottery:read", Desc: "查看抽奖活动", Domain: "lottery",
			Op: "zcard.api.admin.v1.AdminLotteryService/ListLotteryActivities", Method: "GET", Path: "/api/v1/admin/lottery/activities"},
		Perm{Code: "lottery:write", Desc: "查看抽奖配置", Domain: "lottery", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminLotteryService/GetLotteryActivity", Method: "GET", Path: "/api/v1/admin/lottery/activities/{id}"},
		Perm{Code: "lottery:write", Desc: "编辑抽奖活动", Domain: "lottery", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminLotteryService/SaveLotteryActivity", Method: "POST", Path: "/api/v1/admin/lottery/activities"},
		Perm{Code: "lottery:write", Desc: "发布或暂停抽奖", Domain: "lottery", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminLotteryService/SetLotteryStatus", Method: "POST", Path: "/api/v1/admin/lottery/activities/{id}/status"},
		Perm{Code: "lottery:grant", Desc: "补发抽奖次数", Domain: "lottery", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminLotteryService/GrantLotteryChances", Method: "POST", Path: "/api/v1/admin/lottery/activities/{id}/grant"},
		Perm{Code: "lottery:read", Desc: "查看中奖记录", Domain: "lottery",
			Op: "zcard.api.admin.v1.AdminLotteryService/ListLotteryDraws", Method: "GET", Path: "/api/v1/admin/lottery/draws"},
		Perm{Code: "lottery:reveal", Desc: "查看奖品内容", Domain: "lottery", AdminOnly: true,
			Op: "zcard.api.admin.v1.AdminLotteryService/RevealLotteryDraw", Method: "POST", Path: "/api/v1/admin/lottery/draws/{draw_no}/reveal"},
		Perm{Code: "lottery:deliver", Desc: "确认人工发奖", Domain: "lottery",
			Op: "zcard.api.admin.v1.AdminLotteryService/DeliverLotteryDraw", Method: "POST", Path: "/api/v1/admin/lottery/draws/{draw_no}/deliver"},
		Perm{Code: "lottery:read", Desc: "查看抽奖规则历史", Domain: "lottery",
			Op: "zcard.api.admin.v1.AdminLotteryService/ListLotteryHistory", Method: "GET", Path: "/api/v1/admin/lottery/activities/{id}/history"},
		// ── 营销（coupon， ）──────────────────
