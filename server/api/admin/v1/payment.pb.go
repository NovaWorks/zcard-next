...
const file_admin_v1_payment_proto_rawDesc = "" +
	...
	"\vChannelList\x127\n" +
	"\bchannels\x18\x01 \x03(\v2\x1b.zcard.api.admin.v1.ChannelR\bchannels\"\xd5\x01\n" +
	"\aChannel\x12\x0e\n" +
	...
	"\x04sort\x18\t \x01(\x05R\x04sort\"\xe6\x01\n" +
	...
	"\n" +
	"created_at\x18\t \x01(\x03R\tcreatedAt2\x8d\t\n" +
	"\x13AdminPaymentService\x12o\n" +
	"\fListChannels\x12\x16.google.protobuf.Empty\x1a\x1f.zcard.api.admin.v1.ChannelList\"&\x82\xd3\xe4\x93\x02 \x12\x1e/api/v1/admin/payment/channels\x12\x81\x01\n" +
...
var file_admin_v1_payment_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_admin_v1_payment_proto_goTypes = []any{
	...
	(*CreateChannelRequest)(nil),  // 2: zcard.api.admin.v1.CreateChannelRequest
	(*UpdateChannelRequest)(nil),  // 3: zcard.api.admin.v1.UpdateChannelRequest
	(*DeleteChannelRequest)(nil),  // 4: zcard.api.admin.v1.DeleteChannelRequest
	(*ListPaymentsRequest)(nil),   // 5: zcard.api.admin.v1.ListPaymentsRequest
	(*ListPaymentsReply)(nil),     // 6: zcard.api.admin.v1.ListPaymentsReply
	(*GetPaymentRequest)(nil),     // 7: zcard.api.admin.v1.GetPaymentRequest
	(*CapturePaymentRequest)(nil), // 8: zcard.api.admin.v1.CapturePaymentRequest
	(*Payment)(nil),               // 9: zcard.api.admin.v1.Payment
	(*CreateRefundRequest)(nil),   // 10: zcard.api.admin.v1.CreateRefundRequest
	(*ListRefundsRequest)(nil),    // 11: zcard.api.admin.v1.ListRefundsRequest
	(*ListRefundsReply)(nil),      // 12: zcard.api.admin.v1.ListRefundsReply
	(*RefundOrder)(nil),           // 13: zcard.api.admin.v1.RefundOrder
...
var file_admin_v1_payment_proto_depIdxs = []int32{
	...
	9,  // 1: zcard.api.admin.v1.ListPaymentsReply.payments:type_name -> zcard.api.admin.v1.Payment
	13, // 2: zcard.api.admin.v1.ListRefundsReply.refunds:type_name -> zcard.api.admin.v1.RefundOrder
	14, // 3: zcard.api.admin.v1.AdminPaymentService.ListChannels:input_type -> google.protobuf.Empty
	2,  // 4: zcard.api.admin.v1.AdminPaymentService.CreateChannel:input_type -> zcard.api.admin.v1.CreateChannelRequest
	3,  // 5: zcard.api.admin.v1.AdminPaymentService.UpdateChannel:input_type -> zcard.api.admin.v1.UpdateChannelRequest
	4,  // 6: zcard.api.admin.v1.AdminPaymentService.DeleteChannel:input_type -> zcard.api.admin.v1.DeleteChannelRequest
	5,  // 7: zcard.api.admin.v1.AdminPaymentService.ListPayments:input_type -> zcard.api.admin.v1.ListPaymentsRequest
	7,  // 8: zcard.api.admin.v1.AdminPaymentService.GetPayment:input_type -> zcard.api.admin.v1.GetPaymentRequest
	8,  // 9: zcard.api.admin.v1.AdminPaymentService.CapturePayment:input_type -> zcard.api.admin.v1.CapturePaymentRequest
	10, // 10: zcard.api.admin.v1.AdminPaymentService.CreateRefund:input_type -> zcard.api.admin.v1.CreateRefundRequest
	11, // 11: zcard.api.admin.v1.AdminPaymentService.ListRefunds:input_type -> zcard.api.admin.v1.ListRefundsRequest
	0,  // 12: zcard.api.admin.v1.AdminPaymentService.ListChannels:output_type -> zcard.api.admin.v1.ChannelList
	1,  // 13: zcard.api.admin.v1.AdminPaymentService.CreateChannel:output_type -> zcard.api.admin.v1.Channel
	1,  // 14: zcard.api.admin.v1.AdminPaymentService.UpdateChannel:output_type -> zcard.api.admin.v1.Channel
	14, // 15: zcard.api.admin.v1.AdminPaymentService.DeleteChannel:output_type -> google.protobuf.Empty
	6,  // 16: zcard.api.admin.v1.AdminPaymentService.ListPayments:output_type -> zcard.api.admin.v1.ListPaymentsReply
	9,  // 17: zcard.api.admin.v1.AdminPaymentService.GetPayment:output_type -> zcard.api.admin.v1.Payment
	9,  // 18: zcard.api.admin.v1.AdminPaymentService.CapturePayment:output_type -> zcard.api.admin.v1.Payment
	13, // 19: zcard.api.admin.v1.AdminPaymentService.CreateRefund:output_type -> zcard.api.admin.v1.RefundOrder
	12, // 20: zcard.api.admin.v1.AdminPaymentService.ListRefunds:output_type -> zcard.api.admin.v1.ListRefundsReply
