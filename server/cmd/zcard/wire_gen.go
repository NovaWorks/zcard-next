...
func wireApp(serverConf *conf.Server, dataConf *conf.Data, securityConf *conf.Security, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	paymentRepoImpl := payment.NewPaymentRepoImpl(dataData, box, registry, orderLifecycle, portWallet, points, outboxWriter, repoImpl, repoImpl)
	...
	storeSupplierService := supplier.NewStoreSupplierService(supplierRepoImpl)
