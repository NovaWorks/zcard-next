...
func wireApp(serverConf *conf.Server, dataConf *conf.Data, securityConf *conf.Security, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	storeWalletService := wallet.NewStoreWalletService(walletRepoImpl, dataData, settingsReader)
	...
	app := newApp(logger, httpServer, grpcServer, workerServer, backgroundServer, dispatcher, procureService, notifyDispatcher, affiliateService, settleService)
	return app, func() {
		cleanup2()
		cleanup()
	}, nil
