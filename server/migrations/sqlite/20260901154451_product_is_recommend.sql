...
CREATE TABLE `new_products` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, `subsite_id` integer NOT NULL DEFAULT (0), `category_id` integer NULL, `name` text NOT NULL, `slug` text NOT NULL, `description` text NULL, `cover` text NULL, `images` json NULL, `price` integer NOT NULL DEFAULT (0), `factory_price` integer NOT NULL DEFAULT (0), `draft_premium` integer NOT NULL DEFAULT (0), `member_price` json NULL, `points_required` integer NOT NULL DEFAULT (0), `stock_type` text NOT NULL DEFAULT ('card'), `direct_content` blob NULL, `stock_visible` bool NOT NULL DEFAULT (true), `delivery_mode` text NOT NULL DEFAULT ('status'), `control_config` json NULL, `dedup` bool NOT NULL DEFAULT (true), `sort` integer NOT NULL DEFAULT (0), `is_recommend` bool NOT NULL DEFAULT (false), `status` integer NOT NULL DEFAULT (1), `upstream_source_id` integer NULL, `upstream_product_code` text NULL, `upstream_synced_at` datetime NULL);
-- Copy rows from old table "products" to new temporary table "new_products"
INSERT INTO `new_products` (`id`, `created_at`, `updated_at`, `subsite_id`, `category_id`, `name`, `slug`, `description`, `cover`, `images`, `price`, `factory_price`, `draft_premium`, `member_price`, `points_required`, `stock_type`, `direct_content`, `stock_visible`, `delivery_mode`, `control_config`, `dedup`, `sort`, `status`, `upstream_source_id`, `upstream_product_code`, `upstream_synced_at`) SELECT `id`, `created_at`, `updated_at`, `subsite_id`, `category_id`, `name`, `slug`, `description`, `cover`, `images`, `price`, `factory_price`, `draft_premium`, `member_price`, `points_required`, `stock_type`, `direct_content`, `stock_visible`, `delivery_mode`, `control_config`, `dedup`, `sort`, `status`, `upstream_source_id`, `upstream_product_code`, `upstream_synced_at` FROM `products`;
