...
ALTER TABLE `supply_mappings` ADD COLUMN `stock_reference` int NOT NULL DEFAULT -2;
ALTER TABLE `supply_mappings` ADD COLUMN `stock_reference_at` datetime(3) NULL;
